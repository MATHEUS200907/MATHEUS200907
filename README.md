## Olá 👋 Eu sou Matheus Macedo

Sou estudante do curso desinvovimento de sistemas.

Atuo como estudante do ensino medio na Escola Estadual Gorvenador Milton Campos aprendendo sobre as linguagens de programaçao,algoritimos,grafos,etc.

- 💻 sem experiencia.
- ☁️sem profundo dominio.
- 🔐 Interesso-me por **cibersegurança**, **redes neurais** e **inteligência artificial aplicada a sistemas críticos**.
- 👨‍🏫 Atualmente, dedico parte do meu tempo aos estudos sobre algoritimos e diversos sistemas.
- 📚 Uso este repositório para compartilhar materiais, projetos e experiências com a comunidade.

📫 Contato:mtheusbmm9@gmail.com
---
